...
<body style="background: #f7f7f7" class="dash">
    ...
    <div class="col-12 d-flex">
        ...
        <div class="col-12 px-0 py-5 text-center justify-content-center align-items-center ">
            <img src="{{asset('/images/logo.jpg')}}" style="width: 110px;height: 110px;color: #fff;border-radius: 50%" class="d-inline-block">
            </div>
            <div class="col-12 px-0">
                <div class="col-12 px-0">
                    ...
                    <a href="{{route('admin.venues.index')}}" class="col-12 px-0">
                        <div class="col-12 item px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                                <span class="fal fa-solid fa-ticket font-3"> </span>
                            </div>
                            <div style="width: calc(100% - 50px)" class="px-2">
                                الملاعب
                            </div>
                    ...
                    <a href="{{route('admin.events.index')}}" class="col-12 px-0">
                        <div class="col-12 item px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                                <span class="fal fa-solid fa-alarm-clock font-3"> </span>
                            </div>
                            <div style="width: calc(100% - 50px)" class="px-2">
                                الحجوزات
                            </div>
                    ...
                    <a href="{{route('admin.system-calendar.index')}}" class="col-12 px-0">
                        <div class="col-12 item px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                                <span class="fal fa-solid fa-calendar font-3"> </span>
                            </div>
                            <div style="width: calc(100% - 50px)" class="px-2">
                                التقويم
                            </div>
